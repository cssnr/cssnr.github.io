...
export const aboutLinks = [
  ...
  {
    icon: 'fa-brands fa-github',
    text: 'Django Files GitHub',
    href: 'https://github.com/django-files',
  },
  {
    icon: 'fa-brands fa-github',
